...
subtitle: 'Try to keep the notes during study'
author: "FAN Min"
header-style: text
tags:
  - Vim
...
This is FAN Min, a student, and I am working on the phramocoepidimiology studies in the HKU.

Since my team is focusing on the statistical studies with big datasets, in our team, the members are using R or SAS. Now, I spent most of the time in R and I will use SAS in the near future. This blog aims at recording some interesting points about researches or codings.
